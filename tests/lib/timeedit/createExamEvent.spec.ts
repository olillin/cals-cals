...
import { createExamEvent, johannebergExamScheduleUrl, MultiExam} from '../../../app/lib/timeedit'
...
it('follows the expected format for one event', () => {
	...
	const expected = new CalendarEvent('norm_63294', new Date('2026-02-26T12:00:00.000Z'), new Date('2026-03-19T13:00:00.000Z'))
	  .setEnd(new Date('2026-03-19T17:00:00.000Z'))
	  .setLocation('Campus: Johanneberg')
	  .setSummary('Aktivitet: Tentamen. Kurskod: TDA553. Kursnamn: Objektorienterad programmering och design. Registrering: 2025-11-29 - 2026-02-01')
...
it('follows the expected format for two events', () => {
	...
	const expected = new CalendarEvent('norm_63294', new Date('2026-02-26T12:00:00.000Z'), new Date('2026-03-19T13:00:00.000Z'))
	  .setEnd(new Date('2026-03-19T17:00:00.000Z'))
	  .setLocation('Campus: Johanneberg')
	  .setSummary('Aktivitet: Tentamen. Kurskod: TDA553. Kurskod: DIT954. Kursnamn: Objektorienterad programmering och design. Registrering: 2025-11-29 - 2026-02-01')
	  .setProperty('URL', johannebergExamScheduleUrl)
	expected.removePropertiesWithName('DTSTAMP')
